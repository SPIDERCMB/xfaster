...
output_root = os.path.join('/mnt/spider2/xsong/null_tests/202103_gcorrfull', args.output)
...
for tag in ['90','150a']:
    opts = dict(
        data_root='/mnt/spider2/XF_Nulls_Sept18/port',
	...
	weighted_bins = True,
        ...
        verbose='detail',
        residual_fit=True,
	qb_file = '/mnt/spider2/xsong/null_tests/20200325/PS/{}/bandpowers_planck_sub_wbins_{}.npz'.format(tag,tag),
