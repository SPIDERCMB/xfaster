...
def xfaster_run_ensemble(output_root=None, output_tag=None):
    ...
    # inv_fish marginalized (to match bandpowers):
    ...
    for spec in specs:
        ...
        for b0, likeli in enumerate(like):
            ...
            #p0_nomarg = [np.nanmax(L), 1. / width_nomarg**2 / 2., qb0]
            try:
                ...
                #like_marg /= np.trapz(like_marg, bc)
            ...
            try:
                ...
                #like_nomarg /= np.trapz(like_nomarg, likeli[0])
...
if __name__ == "__main__":
    ...
    xfaster_run_ensemble(os.path.join('/data/agambrel/spectra', args.root), args.output_tag)
