...
class XFaster(object):
    ...
    def get_files(
        ...
        if (
            new
            or ret["foreground_transfer_type"] != foreground_transfer_type
            or ret["foreground_subset"] != foreground_subset
        ):
            self.force_rerun["sims_transfer"] = True
            ret1.update(
                self._get_sim_files(
                    "foreground_transfer", foreground_transfer_type, foreground_subset
                )
            )

        if (
            new
            or ret["foreground_type"] != foreground_type
            or ret["foreground_subset"] != foreground_subset
        ):
            self.force_rerun["sims"] = True
            ret1.update(
