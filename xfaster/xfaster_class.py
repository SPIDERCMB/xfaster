            ...
            for spec in specs:
                ...
                for xi, (xname, (tag1, tag2)) in enumerate(map_pairs.items()):
                    ...
                    if comp == "fg":
                        ...
                        fg_scale = freq_scale * (ell / 80.0) ** fg_ell_ind
                        s_arr[xi] = fg_scale * cls_shape[stag][lk]
                    else:
    ...
    def get_likelihood(
        ...
        def log_like(
            ...
            if dust_ell_fit:
                ...
                cls_model_fg = self.get_model_spectra(qb_fg, cbl_fg0)
                if beam is not None:
                    cls_mod_fg_beam = self.get_model_spectra(qb_fg, cbl_fg_beam0)
